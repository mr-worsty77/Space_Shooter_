...
class Enemy:
    def __init__(self):
        ...
        self.sprite = arcade.Sprite("Assets/RED-Enemy.png",scale=0.04)
...
class Boss:
    def __init__(self, x, y):
        ...
        self.sprite = arcade.Sprite("Assets/Boss.png",scale=0.08)
        self.sprite_list = arcade.SpriteList()
        self.sprite_list.append(self.sprite)
...
class GameWindow(arcade.Window):
    ...
    def on_update(self, delta_time):
        ...
        # Boss Spawning
        if not self.boss_spawned and self.score >= 300:   # Change 300 to whatever you like
